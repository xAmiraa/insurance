...
import { AddEditIdentificationTypeComponent } from '../add-edit-identification-type/add-edit-identification-type.component';
...
export class IdentificationTypesComponent extends BaseService implements OnInit {

  filterDto: IdentificationTypeFilterDto = new IdentificationTypeFilterDto();
  ...
  loadData() {
    ...
    this.dataSource.loadObjects(IdentificationTypesController.SearchIdentificationTypes, params);
  }
  ...
  add() {
    this.dialog.open(AddEditIdentificationTypeComponent)
      .afterClosed()
  ...
  activate(Identification: any) {

  }

  deactivate(Identification: any) {

  }

  delete(identification: any) {
    this.sweetAlertService.Delete(IdentificationTypesController.DeleteIdentificationType(identification.id))
      .then(x => {
        this.loadData();
      });
  }
